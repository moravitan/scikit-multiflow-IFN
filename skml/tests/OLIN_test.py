import os
import shutil
from skml import OnlineNetworkRegenerative
...
def test_OLIN():
    ...
    OLIN = OnlineNetworkRegenerative(ifn, test_tmp_folder, n_min=164, n_max=300, init_add_count=50, inc_add_count=70, Pe=0.6)
    OLIN.regenerate()
    _clean_test_env()
